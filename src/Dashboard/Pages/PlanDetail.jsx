...
//             try {
//                 // Fetch user details
//                 const response = await fetch(`http://localhost:3000/get_user/${userId1}`, {
//                     headers: {
...
//                     limit: '15',
//                     visit: '500',
//                     description: 'This is the premium plan with more features than the basic plan.'
//                 };
//             case 'Ultimate':
//                 return {
//                     name: 'Ultimate Plan',
...
//                                     <input autoComplete="off" className='form-input' type="text" name="username" value={formData.Username} placeholder="Name"></input>
//                                     <input autoComplete="off" className='form-input' type="text" name="username" value={formData.Email} placeholder="Email"></input>
//                                 </div>
//                                 <div className='w-100 d-flex flex-column gap-3 align-items-end mt-2'>
//                                     <input autoComplete="off" className='form-input' type="text" name="username" value={'Basic'} placeholder="Current Plan"></input>
//                                     <input autoComplete="off" className='form-input' type="text" name="username" value={'10$'} placeholder="Plan Price"></input>
//                                 </div>
//                             </div>
//                             <div>
//                                 <select
...
//                                 >
//                                     <option value="" disabled hidden>New Plan</option>
//                                     <option className='form-inpu' value="Basic">Basic Plan</option>
//                                     <option className='form-input' value="Premium">Premium Plan</option>
//                                     <option className='form-input' value="Ultimate">Ultimate Plan</option>
//                                 </select>
//                             </div>
//                             {planDetails && (
...
//                                     <tbody>
//                                         <tr>
//                                             <td className='p-2 pe-5 ps-0'><strong>Name:</strong></td>
//                                             <td className='p-2 pe-5 ps-0'>{planDetails.name}</td>
//                                         </tr>
//                                         <tr>
//                                             <td className='p-2 pe-5 ps-0'><strong>Monthly Price:</strong></td>
//                                             <td className='p-2 pe-5 ps-0'>{planDetails.price}</td>
//                                         </tr>
//                                         <tr>
//                                             <td className='p-2 pe-5 ps-0'><strong>User Limit:</strong></td>
//                                             <td className='p-2 pe-5 ps-0'>{planDetails.limit} User</td>
//                                         </tr>
//                                         <tr>
//                                             <td className='p-2 pe-5 ps-0'><strong>Visit:</strong></td>
//                                             <td className='p-2 pe-5 ps-0'>{planDetails.visit}</td>
//                                         </tr>
//                                         <tr>
//                                             <td className='p-2 pe-5 ps-0'><strong>Description:</strong></td>
//                                             <td className='p-2 pe-5 ps-0'>{planDetails.description}</td>
//                                         </tr>
//                                     </tbody>
//                                 </table>
//                             </div>
...
//                                 <button className='dashboard-btn' onClick={''}>Update</button>
//                             </div>
//                         </div>
//                     )}
//                 </Modal>
...
//                                 <button onClick={() => changePlan(selectedUser)} className='dashboard-btn'>Change my plan</button>
...
//             </div>
//             <div className='mt-5'>
//                 <button style={{ fontSize: '16px' }} className="dashboard-btn" onClick={handleBack}>Back</button>
//             </div>
//         </>
//     )
// }
